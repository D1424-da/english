...
EXTRA_QUESTIONS = {
    ...
    "TS-001": [
        ...
        {"difficulty": 1,
         ...
         "explanation": "「水は100度で沸騰する」という変わらない事実は現在形で表します。water は三人称単数扱いなので boils です。",
         "choices": [
             {"text": "boil", "correct": False, "order": 1},
             {"text": "boils", "correct": True, "order": 2},
             {"text": "boiled", "correct": False, "order": 3},
             {"text": "is boiling", "correct": False, "order": 4},
         ]},
        {"difficulty": 1,
    ...
    "TS-002": [
        ...
        {"difficulty": 1,
         ...
         "explanation": "teach の過去形は taught です。catch-caught と同じパターンです。",
         "choices": [
    ...
    "TS-004": [
        {"difficulty": 2,
         "question_text": "空所に入る最も適切な語句を選びなさい。\n\n「When I arrived at the station, the train ___ already left.」",
         "explanation": "「駅に着いた」時点より前に「電車が出発していた」ので過去完了形 had left を使います。",
         "choices": [
    ...
    "TS-005": [
        {"difficulty": 1,
         "question_text": "空所に入る最も適切な語句を選びなさい。\n\n「Look! It ___ outside.」（見て！外は雨が降っているよ）",
         "explanation": "Look! と今まさに起きていることを指しているので、現在進行形 is raining を使います。",
         "choices": [
             {"text": "rains", "correct": False, "order": 1},
             {"text": "is raining", "correct": True, "order": 2},
             {"text": "rained", "correct": False, "order": 3},
             {"text": "rain", "correct": False, "order": 4},
         ]},
        {"difficulty": 1,
    ...
    "TS-006": [
        ...
        {"difficulty": 1,
         ...
         "explanation": "空模様など今の状況から確実に起こりそうなことは be going to で表します。",
         "choices": [
             {"text": "will", "correct": False, "order": 1},
             {"text": "is going to", "correct": True, "order": 2},
             {"text": "shall", "correct": False, "order": 3},
             {"text": "would", "correct": False, "order": 4},
         ]},
        {"difficulty": 2,
    ...
    "VO-001": [
        {"difficulty": 1,
         "question_text": "空所に入る最も適切な語句を選びなさい。\n\n「English ___ in many countries.」（英語は多くの国で話されている）",
         "explanation": "「話されている」という受動態は be動詞 + 過去分詞。speak の過去分詞は spoken です。",
         "choices": [
             {"text": "speaks", "correct": False, "order": 1},
             {"text": "is spoken", "correct": True, "order": 2},
             {"text": "is speaking", "correct": False, "order": 3},
             {"text": "spoke", "correct": False, "order": 4},
         ]},
        {"difficulty": 2,
    ...
    "MD-001": [
        {"difficulty": 1,
         "question_text": "空所に入る最も適切な語を選びなさい。\n\n「___ I use your pen?」(あなたのペンを使ってもいいですか)",
         "explanation": "許可を求める表現は May I 〜? または Can I 〜? です。選択肢の中では May が適切です。",
         "choices": [
             {"text": "May", "correct": True, "order": 1},
    ...
    "IF-001": [
        {"difficulty": 1,
         "question_text": "空所に入る最も適切な語句を選びなさい。\n\n「I want ___ a doctor in the future.」",
         "explanation": "want は to不定詞を目的語にとります。want to be で「〜になりたい」です。",
         "choices": [
    ...
    "RL-001": [
        ...
        {"difficulty": 3,
         "question_text": "空所に入る最も適切な関係代名詞を選びなさい。\n\n「I have a friend ___ father is a pilot.」（父親がパイロットの友達がいる）",
         "explanation": "「友達の父親」という所有の関係を表すので、所有格の関係代名詞 whose を使います。",
         "choices": [
             {"text": "who", "correct": False, "order": 1},
    ...
    "RL-002": [
        {"difficulty": 2,
         ...
         "explanation": "場所を表す先行詞 the town の後ろで、後続の文が完全な文なので関係副詞 where を使います。",
         "choices": [
    ...
    "SB-001": [
        {"difficulty": 3,
         "question_text": "空所に入る最も適切な語句を選びなさい。\n\n「If I ___ a lot of money, I would travel around the world.」",
         "explanation": "現在の事実に反する仮定（実際はお金がない）なので、仮定法過去。if節の動詞は過去形 had です。",
         "choices": [
             {"text": "have", "correct": False, "order": 1},
             {"text": "had", "correct": True, "order": 2},
             {"text": "will have", "correct": False, "order": 3},
             {"text": "would have", "correct": False, "order": 4},
         ]},
        {"difficulty": 3,
