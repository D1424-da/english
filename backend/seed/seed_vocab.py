...
VOCAB_QUESTIONS = {
    ...
    "VB-J2": [
        ...
        {"difficulty": 1,
         "question_text": "次の英単語の意味として正しいものを選びなさい。\n\n「invite」",
         "explanation": "invite は「招待する」という意味の動詞です。名詞形は invitation（招待）です。",
         "choices": [
             {"text": "招待する", "correct": True, "order": 1},
             {"text": "発明する", "correct": False, "order": 2},
             {"text": "調査する", "correct": False, "order": 3},
    ...
    "VB-J3": [
        {"difficulty": 2,
         "question_text": "次の英単語の意味として正しいものを選びなさい。\n\n「effort」",
         "explanation": "effort は「努力」という意味の名詞です。make an effort（努力する）の形でよく使われます。",
         "choices": [
             {"text": "努力", "correct": True, "order": 1},
             {"text": "効果", "correct": False, "order": 2},
             {"text": "誤り", "correct": False, "order": 3},
             {"text": "感情", "correct": False, "order": 4},
         ]},
        {"difficulty": 2,
         "question_text": "次の英単語の意味として正しいものを選びなさい。\n\n「society」",
    ...
    "VB-H1": [
        ...
        {"difficulty": 2,
         "question_text": "次の英単語の意味として正しいものを選びなさい。\n\n「obtain」",
         "explanation": "obtain は「得る、手に入れる」という意味の動詞です。get よりフォーマルな語です。",
         "choices": [
             {"text": "得る", "correct": True, "order": 1},
             {"text": "維持する", "correct": False, "order": 2},
             {"text": "含む", "correct": False, "order": 3},
             {"text": "禁止する", "correct": False, "order": 4},
         ]},
        {"difficulty": 2,
         "question_text": "次の日本語に当たる英単語を選びなさい。\n\n「供給する」",
        ...
        {"difficulty": 2,
         "question_text": "次の英単語の意味として正しいものを選びなさい。\n\n「evidence」",
         "explanation": "evidence は「証拠」という意味の名詞です。evident（明らかな）は形容詞形です。",
         "choices": [
             {"text": "証拠", "correct": True, "order": 1},
             {"text": "出来事", "correct": False, "order": 2},
             {"text": "環境", "correct": False, "order": 3},
             {"text": "評価", "correct": False, "order": 4},
         ]},
        {"difficulty": 2,
         "question_text": "次の日本語に当たる英単語を選びなさい。\n\n「維持する」",
